                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="patientName" placeholder="Search by patient name">
                                        <button class="btn btn-outline-primary" id="searchButton" type="button"><i class="bi bi-search"></i> Search</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <select class="form-control" name="selectedPatient" id="selectedPatient">
                ...
                <script>
                    $(document).ready(function() {
                        $('#searchButton').click(function() {
                            ...
                            $.ajax({
                                url: '../doctor_backend/reports_backend.php',
                                type: 'GET',
                                data: {
                                    name: patientName
                                },
                                success: function(response) {
                                    $('#selectedPatient').html(response);
                                }
                            });
                        });
                    });
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="analysisDate" name="date">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cancerStage" placeholder="AI determined cancer stage" name="cancerStage">
                </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="analysisResult" rows="3" placeholder="AI analysis result" name="analysisResult"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="wbcCount" placeholder="White Blood Cell Count" name="wbcCount">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="blastCellPercentage" class="form-label">Blast Cell Percentage</label>
                    <input type="number" class="form-control" id="blastCellPercentage" placeholder="Blast Cell Percentage" name="blastCellPercentage">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="hemoglobin" placeholder="Hemoglobin Level" name="hemoglobin">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="platelets" class="form-label">Platelets (k/ul)</label>
                    <input type="number" class="form-control" id="platelets" placeholder="Platelets Count" name="platelets">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="recommendations" rows="3"
                    placeholder="Doctor's recommendations and notes" name="recommendations"></textarea>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="treatmentName" placeholder="e.g., Chemotherapy, Radiation" name="treatmentName">
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                <label for="treatmentCycles" class="form-label">Treatment Cycles</label>
                <input type="number" class="form-control" id="treatmentCycles" placeholder="Number of cycles" name="treatmentCycles">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="nextCycleDate" name="nextCycleDate">
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" rows="3"
                    placeholder="Additional notes about the treatment plan"></textarea>
            </div>
        </div>
    </div>
</div>
