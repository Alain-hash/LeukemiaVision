    ...
    <div class="container-fluid p-0">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <!-- Full-Width Simple Patient Selection UI -->
                <div class="container-fluid py-4">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <!-- Clean, simple card for patient selection that spans full width -->
                                                ...
                                                <?php if (!empty($Patients)) { ?>
                                                    <?php foreach ($Patients as $Patient) { ?>
                                                        <option value="<?php echo $Patient['User_ID']; ?>">
                                                            <?php echo $Patient['Name'] . ' - ' . $Patient['User_ID'] ?>
                                                        </option>
                                                    <?php } ?>
                                                <?php } else { ?>
                    ...
                    $(document).ready(function() {
                        $('#patientSelect').on('change', function() {
                            ...
                            if (patientID) {
                                ...
                                $.ajax({
                                    url: '../assistant/assistant_backend/progress/fetchprogressdata.php',
                                    type: 'POST',
                                    data: {
                                        user_id: patientID
                                    },
                                    ...
                                    error: function() {
                                        $('#loadingIndicator').hide();
                                        $('#fetcheddata').html('<div class="alert alert-danger">Error loading patient data.</div>').show();
                                    }
                                });
                            } else {
