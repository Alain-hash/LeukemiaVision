...
$sqlDoctorId = "SELECT Doctor_ID FROM doctor WHERE User_ID = ?";
$stmtDoctorId = $connection->prepare($sqlDoctorId);
$stmtDoctorId->bind_param("i", $user_id);
$stmtDoctorId->execute();
$resultDoctorId = $stmtDoctorId->get_result();
$doctorIdRow = $resultDoctorId->fetch_assoc();
...
// Fetch patients count for today's appointments
$sql6 = "
