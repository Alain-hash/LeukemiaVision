                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="tab-content" id="qaTabContent">
                        ...
                        <div class="tab-pane fade show active" id="all-qa" role="tabpanel" aria-labelledby="all-qa-tab">
                            <form action="assistant_backend/search_qa.php" method="post">
                        ...
                        <div class="tab-pane fade" id="add-qa" role="tabpanel" aria-labelledby="add-qa-tab">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form id="addQAForm" action="assistant_backend/new_qa.php" method="post">
                                        <div class="mb-3">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editQAForm" action="assistant_backend/edit_qa.php" method="post">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="deleteQAForm" action="assistant_backend/delete_qa.php" method="post">
