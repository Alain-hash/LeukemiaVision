...
include ("assistant_backend/account/fetchaccount.php");
include ("assistant_backend/schedule/schedule.php");
...
<head>
    ...
    <title>LeukemiaVision - Assistant Account</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="assistant_backend/account/update_profile_pic.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0 text-primary fw-bold">
                            <i class="bi bi-person-circle me-2"></i>Assistant Account
                        </h2>
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <div class="profile-picture">
                                    <img src="<?php echo '..'.htmlspecialchars($accountData['profile_image']); ?>" alt="Assistant Profile" class="shadow">
                            ...
                            <div class="col-md-9">
                                <div class="d-flex flex-column h-100 justify-content-center">
                                    <h3 class="mb-1 fw-bold"><?php echo htmlspecialchars($accountData['assistantname']); ?></h3>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="info-card">
                                ...
                                <div class="info-value"><?php echo htmlspecialchars($accountData['doctorname']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="info-card">
                                ...
                                <div class="info-value"><?php echo htmlspecialchars($accountData['Email']); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="info-card">
                                ...
                                <div class="info-label">Today's Appointments</div>
                                <div class="info-value"><?php echo htmlspecialchars($PatientCount); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="info-card">
                                ...
                                <div class="info-value">Assistant</div>
                            </div>
                        </div>
                    </div>
